...
contract('Exchange', ([deployer, feeAccount, user1]) => {
   ...
   describe('depositing Ether', async () => {
      ...
      it('emits a Deposit event', async () => {
         ...
         event.user.toString().should.equal(user1, 'user address correct');
   ...
   describe('depositing tokens ', () => {
      ...
      describe('success', () => {
         beforeEach(async () => {
            ...
            it('tracks the token deposit', async () => {
               ...
               it('emits a Deposit event', async () => {
                  ...
                  event.token
                     .toString()
                     .should.equal(token.address, 'token is correct');
                  event.user
                     .toString()
                     .should.equal(user1, 'user address is correct');
                  event.amount.toString().should.equal(amount.toString());
                  event.balance.toString().should.equal(amount.toString());
               });
            });
         ...
         describe('failure', () => {
            ...
            it('fails when no tokens area approved', async () => {
